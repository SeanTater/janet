...
//!
//! ```rust
//! use janet_ai_retriever::status::database::{DatabaseInfo, ConnectionPoolStatus};
//!
//! // Status report would typically be generated by the status API
//! let info = DatabaseInfo {
//!     database_type: "SQLite".to_string(),
//!     database_version: Some("3.40.0".to_string()),
